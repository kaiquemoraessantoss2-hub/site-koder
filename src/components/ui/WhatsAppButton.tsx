...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-[100] flex items-center justify-center w-14 h-14 rounded-full shadow-lg"
      style={{
        background: 'linear-gradient(135deg, #25D366 0%, #1aad52 100%)',
        boxShadow: '0 4px 24px rgba(37,211,102,0.45), 0 0 0 1px rgba(37,211,102,0.25)',
      }}
    >
      {/* Pulse ring */}
      <motion.span
